        ...
        <table class="table">
            ...
            <tbody>
                ...
                while ($row_menu = $result_menu->fetch_assoc()) {
                    ...
                    echo "<form method='post' action='delete_pros.php' onsubmit='return confirmDelete()'>";
                    // Hidden input to store item_id
                    echo "<input type='hidden' name='item_id' value='{$row_menu['item_id']}'>";
